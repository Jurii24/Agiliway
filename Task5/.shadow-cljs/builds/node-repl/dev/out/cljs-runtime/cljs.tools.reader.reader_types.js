...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45932 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45932(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45933 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45933(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45937 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45937(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45938 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45938(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45939 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45939(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45940 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45940(reader);
}
});
...
var G__45978 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45979 = s.append(c);
c = G__45978;
s = G__45979;
continue;
}
