...
var G__46064 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__46064;
continue;
} else {
return ch;
...
var vec__46050 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46050,(0),null);
return (match === s);
});
...
var len__4829__auto___46070 = arguments.length;
var i__4830__auto___46071 = (0);
while(true){
if((i__4830__auto___46071 < len__4829__auto___46070)){
args__4835__auto__.push((arguments[i__4830__auto___46071]));

var G__46072 = (i__4830__auto___46071 + (1));
i__4830__auto___46071 = G__46072;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq46057){
var G__46058 = cljs.core.first(seq46057);
var seq46057__$1 = cljs.core.next(seq46057);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46058,seq46057__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__46073__delegate = function (rdr,_){
...
var G__46073 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__46074__i = 0, G__46074__a = new Array(arguments.length -  1);
while (G__46074__i < G__46074__a.length) {G__46074__a[G__46074__i] = arguments[G__46074__i + 1]; ++G__46074__i;}
  _ = new cljs.core.IndexedSeq(G__46074__a,0,null);
} 
return G__46073__delegate.call(this,rdr,_);};
G__46073.cljs$lang$maxFixedArity = 1;
G__46073.cljs$lang$applyTo = (function (arglist__46075){
var rdr = cljs.core.first(arglist__46075);
var _ = cljs.core.rest(arglist__46075);
return G__46073__delegate(rdr,_);
});
