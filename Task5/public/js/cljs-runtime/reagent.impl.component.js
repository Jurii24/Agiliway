...
if((i < len)){
var k = (ks[i]);
var G__47535 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__47536 = (i + (1));
m = G__47535;
i = G__47536;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__47446 = c;
var G__47446__$1 = (((G__47446 == null))?null:G__47446.prototype);
if((G__47446__$1 == null)){
return null;
} else {
return G__47446__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__47448 = c;
var G__47448__$1 = (((G__47448 == null))?null:G__47448.prototype);
if((G__47448__$1 == null)){
return null;
} else {
return G__47448__$1.render;
}
})() == null)))));
});
...
var G__47460 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__47460) : reagent.impl.component.as_element.call(null,G__47460));
};
...
while (G__47539__i < G__47539__a.length) {G__47539__a[G__47539__i] = arguments[G__47539__i + 0]; ++G__47539__i;}
  args = new cljs.core.IndexedSeq(G__47539__a,0,null);
} 
...
var G__47462 = c;
var G__47462__$1 = (((G__47462 == null))?null:G__47462.constructor);
if((G__47462__$1 == null)){
return null;
} else {
return G__47462__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__47463 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__47464 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__47464);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__47463);
}});
...
var c = this;
var G__47503_47544 = goog.object.get(c,"cljsRatom");
if((G__47503_47544 == null)){
} else {
reagent.ratom.dispose_BANG_(G__47503_47544);
}
...
var renders_47545 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_47546 = cljs.core.first(cljs.core.vals(renders_47545));
...
if((cljs.core.count(renders_47545) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_47545))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_47546)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_47546], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__47531 = o;
goog.object.set(G__47531,cljs.core.name(k),v);
