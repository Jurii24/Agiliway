...
var G__46323 = Object.getPrototypeOf(obj__$1);
...
var iter__4622__auto__ = (function cider$nrepl$inlined_deps$suitable$v0v4v0$suitable$js_introspection$iter__46311(s__46312){
...
var vec__46317 = cljs.core.first(xs__6308__auto__);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46317,(0),null);
var map__46320 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46317,(1),null);
var map__46320__$1 = cljs.core.__destructure_map(map__46320);
var obj = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46320__$1,new cljs.core.Keyword(null,"obj","obj",981763962));
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46320__$1,new cljs.core.Keyword(null,"props","props",453281727));
var iterys__4618__auto__ = ((function (s__46312__$1,vec__46317,i,map__46320,map__46320__$1,obj,props,xs__6308__auto__,temp__5753__auto__,seen){
return (function cider$nrepl$inlined_deps$suitable$v0v4v0$suitable$js_introspection$iter__46311_$_iter__46313(s__46314){
return (new cljs.core.LazySeq(null,((function (s__46312__$1,vec__46317,i,map__46320,map__46320__$1,obj,props,xs__6308__auto__,temp__5753__auto__,seen){
return (function (){
var s__46314__$1 = s__46314;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__46314__$1);
if(temp__5753__auto____$1){
var s__46314__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__46314__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__46314__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__46316 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__46315 = (0);
while(true){
if((i__46315 < size__4621__auto__)){
var key = cljs.core._nth(c__4620__auto__,i__46315);
...
cljs.core.chunk_append(b__46316,(function (){var prop = goog.object.get(props,key);
...
var G__46326 = (i__46315 + (1));
i__46315 = G__46326;
continue;
} else {
var G__46327 = (i__46315 + (1));
i__46315 = G__46327;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46316),cider$nrepl$inlined_deps$suitable$v0v4v0$suitable$js_introspection$iter__46311_$_iter__46313(cljs.core.chunk_rest(s__46314__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46316),null);
}
} else {
var key = cljs.core.first(s__46314__$2);
if(((cljs.core.not(cljs.core.get.cljs$core$IFn$_invoke$arity$2(seen,key))) && (((cljs.core.empty_QMARK_(prefix)) || (clojure.string.starts_with_QMARK_(key,prefix)))))){
...
}catch (e46322){if((e46322 instanceof Error)){
var e = e46322;
return "var";
} else {
throw e46322;
...
})(),cider$nrepl$inlined_deps$suitable$v0v4v0$suitable$js_introspection$iter__46311_$_iter__46313(cljs.core.rest(s__46314__$2)));
} else {
var G__46328 = cljs.core.rest(s__46314__$2);
s__46314__$1 = G__46328;
continue;
}
}
} else {
...
});})(s__46312__$1,vec__46317,i,map__46320,map__46320__$1,obj,props,xs__6308__auto__,temp__5753__auto__,seen))
,null,null));
});})(s__46312__$1,vec__46317,i,map__46320,map__46320__$1,obj,props,xs__6308__auto__,temp__5753__auto__,seen))
;
var fs__4619__auto__ = cljs.core.seq(iterys__4618__auto__(cljs.core.js_keys(props)));
if(fs__4619__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4619__auto__,cider$nrepl$inlined_deps$suitable$v0v4v0$suitable$js_introspection$iter__46311(cljs.core.rest(s__46312__$1)));
} else {
var G__46329 = cljs.core.rest(s__46312__$1);
s__46312__$1 = G__46329;
continue;
}
} else {
return null;
