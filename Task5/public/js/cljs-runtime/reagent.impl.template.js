...
var G__47541 = o;
goog.object.set(G__47541,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__47573__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__47573 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__47574__i = 0, G__47574__a = new Array(arguments.length -  0);
while (G__47574__i < G__47574__a.length) {G__47574__a[G__47574__i] = arguments[G__47574__i + 0]; ++G__47574__i;}
  args = new cljs.core.IndexedSeq(G__47574__a,0,null);
} 
return G__47573__delegate.call(this,args);};
G__47573.cljs$lang$maxFixedArity = 0;
G__47573.cljs$lang$applyTo = (function (arglist__47575){
var args = cljs.core.seq(arglist__47575);
...
var G__47547 = o;
goog.object.set(G__47547,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__47578__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__47579__i < G__47579__a.length) {G__47579__a[G__47579__i] = arguments[G__47579__i + 0]; ++G__47579__i;}
  args = new cljs.core.IndexedSeq(G__47579__a,0,null);
} 
...
var args = cljs.core.seq(arglist__47580);
...
var G__47548 = props;
var G__47548__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47548,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__47548);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47548__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__47548__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__47549 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47549,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__47549;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__47550){
...
return (jsprops.onChange = (function (p1__47552_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__47552_SHARP_);
}));
} else {
return null;
}
...
var vec__47554 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47554,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47554,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47554,(2),null);
...
var temp__5757__auto___47586 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___47586 == null)){
} else {
var key_47588 = temp__5757__auto___47586;
(jsprops.key = key_47588);
}
...
var temp__5757__auto___47589 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___47589 == null)){
} else {
var key_47590 = temp__5757__auto___47589;
(jsprops.key = key_47590);
}
...
var G__47558 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__47558) : reagent.impl.template.as_element.call(null,G__47558));
} else {
var temp__5757__auto___47591 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___47591 == null)){
} else {
var key_47592 = temp__5757__auto___47591;
(jsprops.key = key_47592);
}
...
var G__47560 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__47560)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__47560)){
return x;
} else {
...
var i__4830__auto___47594 = (0);
while(true){
if((i__4830__auto___47594 < len__4829__auto___47593)){
args__4835__auto__.push((arguments[i__4830__auto___47594]));

var G__47595 = (i__4830__auto___47594 + (1));
i__4830__auto___47594 = G__47595;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq47561){
var G__47562 = cljs.core.first(seq47561);
var seq47561__$1 = cljs.core.next(seq47561);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47562,seq47561__$1);
}));
...
break;
default:
var G__47618 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__47618;
continue;
...
var ctx = ({});
var vec__47565 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47565,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47565,(1),null);
...
var G__47568 = (cljs.core.count(argv) - first_child);
switch (G__47568) {
case (0):
