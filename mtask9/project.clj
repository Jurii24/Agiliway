(defproject mtask9 "0.1.0-SNAPSHOT"
...
; Starting Jack-in Terminal: npx shadow-cljs -d cider/cider-nrepl:0.26.0 watch :app
  ...
  :ring {:handler mtask9.handler/app
         :uberwar-name "mtask9.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "mtask9.jar"
  :main mtask9.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "mtask9.core/mount-root"}
             :compiler
             {:main "mtask9.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns mtask9.repl}
