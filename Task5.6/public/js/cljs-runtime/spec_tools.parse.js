...
var fexpr__47750 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__47750.cljs$core$IFn$_invoke$arity$1 ? fexpr__47750.cljs$core$IFn$_invoke$arity$1(type) : fexpr__47750.call(null,type));
});
...
var G__47953 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__47953;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__47751 = spec_tools.impl.normalize_symbol(x);
var G__47752 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__47751,G__47752) : spec_tools.parse.parse_form.call(null,G__47751,G__47752));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__47754 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__47755 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__47754,G__47755) : spec_tools.parse.parse_form.call(null,G__47754,G__47755));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__47954 = cljs.spec.alpha.form(x);
x = G__47954;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__47756 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__47757 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__47756,G__47757) : spec_tools.parse.parse_form.call(null,G__47756,G__47757));
} else {
...
var G__47764 = parse_data;
var G__47764__$1 = (((G__47764 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__47764));
var G__47764__$2 = (((G__47764__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__47764__$1));
var G__47764__$3 = (((G__47764__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__47764__$2));
var G__47764__$4 = (((G__47764__$3 == null))?null:cljs.core.seq(G__47764__$3));
if((G__47764__$4 == null)){
return null;
} else {
return cljs.core.set(G__47764__$4);
}
}
});
...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__47765 = cljs.core.get_global_hierarchy;
return (fexpr__47765.cljs$core$IFn$_invoke$arity$0 ? fexpr__47765.cljs$core$IFn$_invoke$arity$0() : fexpr__47765.call(null));
})());
...
var map__47801 = spec_tools.impl.parse_keys(form);
var map__47801__$1 = cljs.core.__destructure_map(map__47801);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47801__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47801__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47801__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47801__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47801__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__47806 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__47806__$1 = (cljs.core.truth_((function (){var or__4223__auto__ = req;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47806,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__47806);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47806__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__47806__$1;
}
}));
...
var vec__47837 = multi_spec_form;
...
var _ = first__47839;
var first__47839__$1 = cljs.core.first(seq__47838__$1);
var seq__47838__$2 = cljs.core.next(seq__47838__$1);
var multi_method_symbol = first__47839__$1;
var ___$1 = seq__47838__$2;
var form = vec__47837;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__47840){
var vec__47841 = p__47840;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47841,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47841,(1),null);
...
var type_priority = (function (p1__47873_SHARP_){
var G__47875 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(0),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(1)], null);
var G__47876 = (0);
var fexpr__47874 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__47873_SHARP_);
...
var map__47879 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__47879__$1 = cljs.core.__destructure_map(map__47879);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47879__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__47891 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__47891__$1 = cljs.core.__destructure_map(map__47891);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47891__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__47906){
var vec__47907 = p__47906;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47907,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47907,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47907,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__47912){
...
var ___$1 = first__47915;
var values = seq__47914__$1;
...
var type_priority = (function (p1__47920_SHARP_){
var G__47951 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__47950 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__47920_SHARP_);
return (fexpr__47950.cljs$core$IFn$_invoke$arity$1 ? fexpr__47950.cljs$core$IFn$_invoke$arity$1(G__47951) : fexpr__47950.call(null,G__47951));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.parse_spec,cljs.core.rest(form))));
}));
