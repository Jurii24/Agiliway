...
var len__4829__auto___49605 = arguments.length;
var i__4830__auto___49606 = (0);
while(true){
if((i__4830__auto___49606 < len__4829__auto___49605)){
args_arr__4850__auto__.push((arguments[i__4830__auto___49606]));

var G__49609 = (i__4830__auto___49606 + (1));
i__4830__auto___49606 = G__49609;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.core.rrb_vector.catvec.cljs$lang$applyTo = (function (seq49525){
var G__49526 = cljs.core.first(seq49525);
var seq49525__$1 = cljs.core.next(seq49525);
var G__49527 = cljs.core.first(seq49525__$1);
var seq49525__$2 = cljs.core.next(seq49525__$1);
var G__49528 = cljs.core.first(seq49525__$2);
var seq49525__$3 = cljs.core.next(seq49525__$2);
var G__49529 = cljs.core.first(seq49525__$3);
var seq49525__$4 = cljs.core.next(seq49525__$3);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49526,G__49527,G__49528,G__49529,seq49525__$4);
}));
...
default:
var args_arr__4850__auto__ = [];
var len__4829__auto___49627 = arguments.length;
var i__4830__auto___49628 = (0);
while(true){
if((i__4830__auto___49628 < len__4829__auto___49627)){
args_arr__4850__auto__.push((arguments[i__4830__auto___49628]));

var G__49631 = (i__4830__auto___49628 + (1));
i__4830__auto___49628 = G__49631;
continue;
} else {
}
break;
...
var arr__49587 = [];
return (new clojure.core.rrb_vector.rrbt.Vector(0,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49587,null,null));
}));
...
return (new clojure.core.rrb_vector.rrbt.Vector(1,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49589,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$2 = (function (x1,x2){
var arr__49593 = [null,null];
(arr__49593[(0)] = x1);

(arr__49593[(1)] = x2);

return (new clojure.core.rrb_vector.rrbt.Vector(2,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49593,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$3 = (function (x1,x2,x3){
var arr__49594 = [null,null,null];
(arr__49594[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(3,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49594,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$4 = (function (x1,x2,x3,x4){
var arr__49595 = [null,null,null,null];
(arr__49595[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(4,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__49595,null,null));
}));
...
/** @this {Function} */
(clojure.core.rrb_vector.vector.cljs$lang$applyTo = (function (seq49573){
...
var G__49576 = cljs.core.first(seq49573__$2);
var seq49573__$3 = cljs.core.next(seq49573__$2);
var G__49577 = cljs.core.first(seq49573__$3);
var seq49573__$4 = cljs.core.next(seq49573__$3);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49574,G__49575,G__49576,G__49577,seq49573__$4);
}));
