...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__49080 = cljs.core.get_global_hierarchy;
return (fexpr__49080.cljs$core$IFn$_invoke$arity$0 ? fexpr__49080.cljs$core$IFn$_invoke$arity$0() : fexpr__49080.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__49088){
var map__49089 = p__49088;
var map__49089__$1 = cljs.core.__destructure_map(map__49089);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49089__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49089__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__49094 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49094,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49094,(1),null);
...
var method_cache__4714__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4715__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__49107 = cljs.core.get_global_hierarchy;
return (fexpr__49107.cljs$core$IFn$_invoke$arity$0 ? fexpr__49107.cljs$core$IFn$_invoke$arity$0() : fexpr__49107.call(null));
})());
...
var map__49113 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__49113__$1 = cljs.core.__destructure_map(map__49113);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49113__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49113__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__49114){
var vec__49115 = p__49114;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49115,(0),null);
var map__49118 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49115,(1),null);
var map__49118__$1 = cljs.core.__destructure_map(map__49118);
var schema = map__49118__$1;
...
var method_cache__4714__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4715__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__49122 = cljs.core.get_global_hierarchy;
return (fexpr__49122.cljs$core$IFn$_invoke$arity$0 ? fexpr__49122.cljs$core$IFn$_invoke$arity$0() : fexpr__49122.call(null));
})());
...
})(),(function (){var iter__4622__auto__ = (function spec_tools$swagger$core$iter__49124(s__49125){
return (new cljs.core.LazySeq(null,(function (){
var s__49125__$1 = s__49125;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__49125__$1);
if(temp__5753__auto__){
var s__49125__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49125__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__49125__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__49127 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__49126 = (0);
while(true){
if((i__49126 < size__4621__auto__)){
var vec__49135 = cljs.core._nth(c__4620__auto__,i__49126);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49135,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49135,(1),null);
cljs.core.chunk_append(b__49127,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49127),spec_tools$swagger$core$iter__49124(cljs.core.chunk_rest(s__49125__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49127),null);
}
} else {
var vec__49142 = cljs.core.first(s__49125__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49142,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49142,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__49124(cljs.core.rest(s__49125__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__49146){
var vec__49147 = p__49146;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49147,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49147,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__49150,p){
var vec__49151 = p__49150;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49151,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49151,(1),null);
var acc__$1 = vec__49151;
