...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__49040 = cljs.core.get_global_hierarchy;
return (fexpr__49040.cljs$core$IFn$_invoke$arity$0 ? fexpr__49040.cljs$core$IFn$_invoke$arity$0() : fexpr__49040.call(null));
})());
...
var map__49053 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__49053__$1 = cljs.core.__destructure_map(map__49053);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49053__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49053__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49053__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49053__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__49060 = spec_tools.parse.parse_spec(form);
var map__49060__$1 = cljs.core.__destructure_map(map__49060);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49060__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__49061 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49061__$1)].join('')));
...
var vec__49067 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49067,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49067,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49067,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49067,(3),null);
...
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49070,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49070,(1),null);
...
var extra_info = (function (){var G__49073 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49073,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__49073;
}
})();
