...
if((i < len)){
var k = (ks[i]);
var G__44497 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__44498 = (i + (1));
m = G__44497;
i = G__44498;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__44416 = c;
var G__44416__$1 = (((G__44416 == null))?null:G__44416.prototype);
if((G__44416__$1 == null)){
return null;
} else {
return G__44416__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__44421 = c;
var G__44421__$1 = (((G__44421 == null))?null:G__44421.prototype);
if((G__44421__$1 == null)){
return null;
} else {
return G__44421__$1.render;
}
})() == null)))));
});
...
var G__44424 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__44424) : reagent.impl.component.as_element.call(null,G__44424));
};
...
var G__44426 = c;
var G__44426__$1 = (((G__44426 == null))?null:G__44426.constructor);
if((G__44426__$1 == null)){
return null;
} else {
return G__44426__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__44428 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__44429 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__44429);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__44428);
}});
...
var c = this;
var G__44495_44505 = goog.object.get(c,"cljsRatom");
if((G__44495_44505 == null)){
} else {
reagent.ratom.dispose_BANG_(G__44495_44505);
}
...
var renders_44506 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_44507 = cljs.core.first(cljs.core.vals(renders_44506));
...
if((cljs.core.count(renders_44506) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_44506))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_44507)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_44507], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__44496 = o;
goog.object.set(G__44496,cljs.core.name(k),v);
