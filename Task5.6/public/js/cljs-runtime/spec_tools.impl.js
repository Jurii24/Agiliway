...
var vec__47701 = cljs.core.rest(expr);
var seq__47702 = cljs.core.seq(vec__47701);
var first__47703 = cljs.core.first(seq__47702);
var seq__47702__$1 = cljs.core.next(seq__47702);
var vec__47704 = first__47703;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47704,(0),null);
var form = seq__47702__$1;
...
var G__47708 = x;
var G__47708__$1 = (((G__47708 == null))?null:spec_tools.impl.polish(G__47708));
var G__47708__$2 = (((G__47708__$1 == null))?null:cljs.core.name(G__47708__$1));
if((G__47708__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47708__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__47709 = x;
var G__47709__$1 = (((G__47709 == null))?null:cljs.core.name(G__47709));
if((G__47709__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47709__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__47710){
var map__47711 = p__47710;
var map__47711__$1 = cljs.core.__destructure_map(map__47711);
var data = map__47711__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47711__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47711__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47711__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47711__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__47712){
var map__47713 = p__47712;
var map__47713__$1 = cljs.core.__destructure_map(map__47713);
var data = map__47713__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47713__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47713__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__47714 = data;
var G__47714__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47714,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__47714);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47714__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__47714__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__47718 = form;
var G__47718__$1 = (((G__47718 == null))?null:cljs.core.rest(G__47718));
if((G__47718__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47718__$1);
}
})();
var G__47719 = m;
var G__47719__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47719,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__47715_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47715_SHARP_)));
})):G__47719);
var G__47719__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47719__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__47716_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47716_SHARP_)));
})):G__47719__$1);
var G__47719__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47719__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__47717_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__47717_SHARP_));
})):G__47719__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__47719__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__47720 = (function (){var G__47721 = form;
var G__47721__$1 = (((G__47721 == null))?null:cljs.core.rest(G__47721));
if((G__47721__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47721__$1);
}
})();
var map__47720__$1 = cljs.core.__destructure_map(map__47720);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47720__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47720__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47720__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47720__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__47730 = (function (){var and__4221__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__47731 = form;
var G__47731__$1 = (((G__47731 == null))?null:cljs.core.seq(G__47731));
var G__47731__$2 = (((G__47731__$1 == null))?null:cljs.core.first(G__47731__$1));
if((G__47731__$2 == null)){
return null;
} else {
var fexpr__47732 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__47732.cljs$core$IFn$_invoke$arity$1 ? fexpr__47732.cljs$core$IFn$_invoke$arity$1(G__47731__$2) : fexpr__47732.call(null,G__47731__$2));
}
})():null));
});
/**
...
var len__4829__auto___47761 = arguments.length;
var i__4830__auto___47762 = (0);
while(true){
if((i__4830__auto___47762 < len__4829__auto___47761)){
args__4835__auto__.push((arguments[i__4830__auto___47762]));

var G__47763 = (i__4830__auto___47762 + (1));
i__4830__auto___47762 = G__47763;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq47734){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47734));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__47736){
var vec__47737 = p__47736;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47737,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47737,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__47746){
var map__47747 = p__47746;
var map__47747__$1 = cljs.core.__destructure_map(map__47747);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47747__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47747__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47747__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47747__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__47744_SHARP_){
return cljs.core.map_QMARK_(p1__47744_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__47745_SHARP_){
return cljs.core.contains_QMARK_(p1__47745_SHARP_,x);
});
}),req_keys));
