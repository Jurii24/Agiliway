...
var i_46347 = (0);
while(true){
if((i_46347 < arr.length)){
(arr[i_46347] = null);

var G__46348 = (i_46347 + (1));
i_46347 = G__46348;
continue;
} else {
}
...
var i_46357 = (self__.level + (1));
while(true){
if((i_46357 <= (new_level + (1)))){
(update[i_46357] = self__.header);

var G__46358 = (i_46357 + (1));
i_46357 = G__46358;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_46359 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_46359[i]));
} else {
x__$2.forward.push((((i < links_46359.length))?(links_46359[i]):null));
}

if((i < links_46359.length)){
(links_46359[i] = x__$2);
} else {
links_46359.push(x__$2);
}
...
var i_46365 = (0);
while(true){
if((i_46365 <= self__.level)){
var links_46366 = (update[i_46365]).forward;
if((x__$1 === (((i_46365 < links_46366.length))?(links_46366[i_46365]):null))){
(links_46366[i_46365] = (x__$1.forward[i_46365]));

var G__46367 = (i_46365 + (1));
i_46365 = G__46367;
continue;
} else {
var G__46368 = (i_46365 + (1));
i_46365 = G__46368;
continue;
}
} else {
...
var G__46370 = nx;
var G__46371 = (level__$1 - (1));
x = G__46370;
level__$1 = G__46371;
continue;
} else {
var G__46372 = x;
var G__46373 = (level__$1 - (1));
x = G__46372;
level__$1 = G__46373;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__46376 = nx;
var G__46377 = (level__$1 - (1));
x = G__46376;
level__$1 = G__46377;
continue;
} else {
var G__46378 = x;
var G__46380 = (level__$1 - (1));
x = G__46378;
level__$1 = G__46380;
continue;
}
