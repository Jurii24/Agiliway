...
return (function() { 
var G__44541__delegate = function (args){
...
while (G__44542__i < G__44542__a.length) {G__44542__a[G__44542__i] = arguments[G__44542__i + 0]; ++G__44542__i;}
  args = new cljs.core.IndexedSeq(G__44542__a,0,null);
} 
return G__44541__delegate.call(this,args);};
G__44541.cljs$lang$maxFixedArity = 0;
G__44541.cljs$lang$applyTo = (function (arglist__44543){
var args = cljs.core.seq(arglist__44543);
return G__44541__delegate(args);
});
...
var G__44509 = o;
goog.object.set(G__44509,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__44548__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__44550__i < G__44550__a.length) {G__44550__a[G__44550__i] = arguments[G__44550__i + 0]; ++G__44550__i;}
  args = new cljs.core.IndexedSeq(G__44550__a,0,null);
} 
return G__44548__delegate.call(this,args);};
G__44548.cljs$lang$maxFixedArity = 0;
G__44548.cljs$lang$applyTo = (function (arglist__44551){
var args = cljs.core.seq(arglist__44551);
return G__44548__delegate(args);
});
...
var G__44510 = props;
var G__44510__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44510,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44510);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44510__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__44510__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__44511 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44511,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__44511;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__44512){
var map__44513 = p__44512;
var map__44513__$1 = cljs.core.__destructure_map(map__44513);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44513__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__44514_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__44514_SHARP_);
}));
} else {
return null;
}
...
var vec__44516 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44516,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44516,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44516,(2),null);
...
var temp__5757__auto___44569 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___44569 == null)){
} else {
var key_44570 = temp__5757__auto___44569;
(jsprops.key = key_44570);
}
...
var temp__5757__auto___44576 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___44576 == null)){
} else {
var key_44577 = temp__5757__auto___44576;
(jsprops.key = key_44577);
}
...
var G__44520 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__44520) : reagent.impl.template.as_element.call(null,G__44520));
} else {
var temp__5757__auto___44582 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___44582 == null)){
} else {
var key_44584 = temp__5757__auto___44582;
(jsprops.key = key_44584);
}
...
var G__44522 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__44522)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__44522)){
return x;
} else {
...
var len__4829__auto___44586 = arguments.length;
var i__4830__auto___44587 = (0);
while(true){
if((i__4830__auto___44587 < len__4829__auto___44586)){
args__4835__auto__.push((arguments[i__4830__auto___44587]));

var G__44588 = (i__4830__auto___44587 + (1));
i__4830__auto___44587 = G__44588;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq44523){
var G__44524 = cljs.core.first(seq44523);
var seq44523__$1 = cljs.core.next(seq44523);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44524,seq44523__$1);
}));
...
break;
default:
var G__44597 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__44597;
continue;
...
var ctx = ({});
var vec__44527 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44527,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44527,(1),null);
...
var G__44530 = (cljs.core.count(argv) - first_child);
switch (G__44530) {
case (0):
