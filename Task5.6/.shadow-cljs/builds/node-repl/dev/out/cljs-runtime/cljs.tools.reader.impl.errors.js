...
var len__4829__auto___46019 = arguments.length;
var i__4830__auto___46020 = (0);
while(true){
if((i__4830__auto___46020 < len__4829__auto___46019)){
args__4835__auto__.push((arguments[i__4830__auto___46020]));

var G__46021 = (i__4830__auto___46020 + (1));
i__4830__auto___46020 = G__46021;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq45934){
var G__45935 = cljs.core.first(seq45934);
var seq45934__$1 = cljs.core.next(seq45934);
var G__45936 = cljs.core.first(seq45934__$1);
var seq45934__$2 = cljs.core.next(seq45934__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45935,G__45936,seq45934__$2);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___46024 = arguments.length;
var i__4830__auto___46025 = (0);
while(true){
if((i__4830__auto___46025 < len__4829__auto___46024)){
args__4835__auto__.push((arguments[i__4830__auto___46025]));

var G__46026 = (i__4830__auto___46025 + (1));
i__4830__auto___46025 = G__46026;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq45941){
var G__45942 = cljs.core.first(seq45941);
var seq45941__$1 = cljs.core.next(seq45941);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45942,seq45941__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___46028 = arguments.length;
var i__4830__auto___46029 = (0);
while(true){
if((i__4830__auto___46029 < len__4829__auto___46028)){
args__4835__auto__.push((arguments[i__4830__auto___46029]));

var G__46030 = (i__4830__auto___46029 + (1));
i__4830__auto___46029 = G__46030;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq45943){
var G__45944 = cljs.core.first(seq45943);
var seq45943__$1 = cljs.core.next(seq45943);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45944,seq45943__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___46031 = arguments.length;
var i__4830__auto___46032 = (0);
while(true){
if((i__4830__auto___46032 < len__4829__auto___46031)){
args__4835__auto__.push((arguments[i__4830__auto___46032]));

var G__46033 = (i__4830__auto___46032 + (1));
i__4830__auto___46032 = G__46033;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq45947){
var G__45948 = cljs.core.first(seq45947);
var seq45947__$1 = cljs.core.next(seq45947);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45948,seq45947__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___46037 = arguments.length;
var i__4830__auto___46038 = (0);
while(true){
if((i__4830__auto___46038 < len__4829__auto___46037)){
args__4835__auto__.push((arguments[i__4830__auto___46038]));

var G__46039 = (i__4830__auto___46038 + (1));
i__4830__auto___46038 = G__46039;
continue;
} else {
}
break;
...
var init = (function (){var G__45971 = kind;
var G__45971__$1 = (((G__45971 instanceof cljs.core.Keyword))?G__45971.fqn:null);
switch (G__45971__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45971__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq45963){
var G__45965 = cljs.core.first(seq45963);
var seq45963__$1 = cljs.core.next(seq45963);
var G__45966 = cljs.core.first(seq45963__$1);
var seq45963__$2 = cljs.core.next(seq45963__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45965,G__45966,seq45963__$2);
}));
...
var iter__4622__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__46002(s__46003){
return (new cljs.core.LazySeq(null,(function (){
var s__46003__$1 = s__46003;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__46003__$1);
if(temp__5753__auto__){
var s__46003__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46003__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__46003__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__46005 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__46004 = (0);
while(true){
if((i__46004 < size__4621__auto__)){
var vec__46007 = cljs.core._nth(c__4620__auto__,i__46004);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46007,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46007,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__46005,id);

var G__46044 = (i__46004 + (1));
i__46004 = G__46044;
continue;
} else {
var G__46045 = (i__46004 + (1));
i__46004 = G__46045;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46005),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__46002(cljs.core.chunk_rest(s__46003__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46005),null);
}
} else {
var vec__46011 = cljs.core.first(s__46003__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46011,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46011,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__46002(cljs.core.rest(s__46003__$2)));
} else {
var G__46047 = cljs.core.rest(s__46003__$2);
s__46003__$1 = G__46047;
continue;
}
}
} else {
