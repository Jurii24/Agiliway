...
var i_57360 = (0);
while(true){
if((i_57360 < arr.length)){
(arr[i_57360] = null);

var G__57361 = (i_57360 + (1));
i_57360 = G__57361;
continue;
} else {
}
...
var i_57373 = (self__.level + (1));
while(true){
if((i_57373 <= (new_level + (1)))){
(update[i_57373] = self__.header);

var G__57374 = (i_57373 + (1));
i_57373 = G__57374;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_57375 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_57375[i]));
} else {
x__$2.forward.push((((i < links_57375.length))?(links_57375[i]):null));
}

if((i < links_57375.length)){
(links_57375[i] = x__$2);
} else {
links_57375.push(x__$2);
}
...
var i_57383 = (0);
while(true){
if((i_57383 <= self__.level)){
var links_57384 = (update[i_57383]).forward;
if((x__$1 === (((i_57383 < links_57384.length))?(links_57384[i_57383]):null))){
(links_57384[i_57383] = (x__$1.forward[i_57383]));

var G__57385 = (i_57383 + (1));
i_57383 = G__57385;
continue;
} else {
var G__57386 = (i_57383 + (1));
i_57383 = G__57386;
continue;
}
} else {
...
var G__57394 = nx;
var G__57395 = (level__$1 - (1));
x = G__57394;
level__$1 = G__57395;
continue;
} else {
var G__57396 = x;
var G__57397 = (level__$1 - (1));
x = G__57396;
level__$1 = G__57397;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__57399 = nx;
var G__57400 = (level__$1 - (1));
x = G__57399;
level__$1 = G__57400;
continue;
} else {
var G__57401 = x;
var G__57402 = (level__$1 - (1));
x = G__57401;
level__$1 = G__57402;
continue;
}
