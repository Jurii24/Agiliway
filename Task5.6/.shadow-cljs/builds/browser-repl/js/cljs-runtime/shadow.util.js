...
var len__4829__auto___61359 = arguments.length;
var i__4830__auto___61360 = (0);
while(true){
if((i__4830__auto___61360 < len__4829__auto___61359)){
args_arr__4850__auto__.push((arguments[i__4830__auto___61360]));

var G__61361 = (i__4830__auto___61360 + (1));
i__4830__auto___61360 = G__61361;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq61343){
var G__61344 = cljs.core.first(seq61343);
var seq61343__$1 = cljs.core.next(seq61343);
var G__61345 = cljs.core.first(seq61343__$1);
var seq61343__$2 = cljs.core.next(seq61343__$1);
var G__61346 = cljs.core.first(seq61343__$2);
var seq61343__$3 = cljs.core.next(seq61343__$2);
var G__61347 = cljs.core.first(seq61343__$3);
var seq61343__$4 = cljs.core.next(seq61343__$3);
var G__61348 = cljs.core.first(seq61343__$4);
var seq61343__$5 = cljs.core.next(seq61343__$4);
var G__61349 = cljs.core.first(seq61343__$5);
var seq61343__$6 = cljs.core.next(seq61343__$5);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61344,G__61345,G__61346,G__61347,G__61348,G__61349,seq61343__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__61351){
var vec__61352 = p__61351;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61352,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61352,(1),null);
