...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_55867 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_55867(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_55869 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_55869(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_55871 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_55871(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_55874 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_55874(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_55875 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_55875(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_55879 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_55879(reader);
}
});
