...
var G__44645 = o;
goog.object.set(G__44645,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__44679__i = 0, G__44679__a = new Array(arguments.length -  0);
while (G__44679__i < G__44679__a.length) {G__44679__a[G__44679__i] = arguments[G__44679__i + 0]; ++G__44679__i;}
  args = new cljs.core.IndexedSeq(G__44679__a,0,null);
} 
return G__44678__delegate.call(this,args);};
G__44678.cljs$lang$maxFixedArity = 0;
G__44678.cljs$lang$applyTo = (function (arglist__44680){
...
var G__44647 = o;
goog.object.set(G__44647,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__44681__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__44682__i < G__44682__a.length) {G__44682__a[G__44682__i] = arguments[G__44682__i + 0]; ++G__44682__i;}
  args = new cljs.core.IndexedSeq(G__44682__a,0,null);
} 
return G__44681__delegate.call(this,args);};
G__44681.cljs$lang$maxFixedArity = 0;
G__44681.cljs$lang$applyTo = (function (arglist__44683){
var args = cljs.core.seq(arglist__44683);
return G__44681__delegate(args);
});
...
var G__44651 = props;
var G__44651__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44651,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44651);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44651__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__44651__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__44652 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44652,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__44652;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__44654){
var map__44655 = p__44654;
var map__44655__$1 = cljs.core.__destructure_map(map__44655);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44655__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__44658_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__44658_SHARP_);
}));
} else {
return null;
}
...
var vec__44662 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44662,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44662,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44662,(2),null);
...
var temp__5757__auto___44692 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___44692 == null)){
} else {
var key_44693 = temp__5757__auto___44692;
(jsprops.key = key_44693);
}
...
var temp__5757__auto___44694 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___44694 == null)){
} else {
var key_44695 = temp__5757__auto___44694;
(jsprops.key = key_44695);
}
...
var G__44666 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__44666) : reagent.impl.template.as_element.call(null,G__44666));
} else {
var temp__5757__auto___44696 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___44696 == null)){
} else {
var key_44697 = temp__5757__auto___44696;
(jsprops.key = key_44697);
}
...
var G__44668 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__44668)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__44668)){
return x;
} else {
...
var len__4829__auto___44698 = arguments.length;
var i__4830__auto___44699 = (0);
while(true){
if((i__4830__auto___44699 < len__4829__auto___44698)){
args__4835__auto__.push((arguments[i__4830__auto___44699]));

var G__44700 = (i__4830__auto___44699 + (1));
i__4830__auto___44699 = G__44700;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq44669){
var G__44670 = cljs.core.first(seq44669);
var seq44669__$1 = cljs.core.next(seq44669);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44670,seq44669__$1);
}));
...
break;
default:
var G__44702 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__44702;
continue;
...
var ctx = ({});
var vec__44673 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44673,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44673,(1),null);
...
var G__44676 = (cljs.core.count(argv) - first_child);
switch (G__44676) {
case (0):
