...
var i_45867 = (0);
while(true){
if((i_45867 < arr.length)){
(arr[i_45867] = null);

var G__45868 = (i_45867 + (1));
i_45867 = G__45868;
continue;
} else {
}
...
var i_45880 = (self__.level + (1));
while(true){
if((i_45880 <= (new_level + (1)))){
(update[i_45880] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_45882 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45882[i]));
} else {
x__$2.forward.push((((i < links_45882.length))?(links_45882[i]):null));
}

if((i < links_45882.length)){
(links_45882[i] = x__$2);
} else {
links_45882.push(x__$2);
}
...
var i_45896 = (0);
while(true){
if((i_45896 <= self__.level)){
var links_45897 = (update[i_45896]).forward;
if((x__$1 === (((i_45896 < links_45897.length))?(links_45897[i_45896]):null))){
(links_45897[i_45896] = (x__$1.forward[i_45896]));

var G__45899 = (i_45896 + (1));
i_45896 = G__45899;
continue;
} else {
var G__45900 = (i_45896 + (1));
i_45896 = G__45900;
continue;
}
} else {
...
var G__45904 = nx;
var G__45905 = (level__$1 - (1));
x = G__45904;
level__$1 = G__45905;
continue;
} else {
var G__45906 = x;
var G__45907 = (level__$1 - (1));
x = G__45906;
level__$1 = G__45907;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__45911 = nx;
var G__45912 = (level__$1 - (1));
x = G__45911;
level__$1 = G__45912;
continue;
} else {
var G__45913 = x;
var G__45914 = (level__$1 - (1));
x = G__45913;
level__$1 = G__45914;
continue;
}
